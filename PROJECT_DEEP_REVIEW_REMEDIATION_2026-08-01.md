...
| F-12 | Historical documentation closure; licensing later superseded | At executable baseline `de3f697`, README stated the then-current source-available BSL terms and used repository installation because no PyPI publication was verified. The project was relicensed to Apache-2.0 on 2026-08-02; this row remains a dated audit record, not the current license. Publishing a package remains authorization- and credential-dependent. |
