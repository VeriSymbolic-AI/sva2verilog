...
Current hardening worktree (based on `8e7af87`, v1.7.0) fixes wheel template
omission, pins reproducible Verilator/formal toolchains, isolates expensive
formal shards, and removes importer declaration-state leakage. Local results are
